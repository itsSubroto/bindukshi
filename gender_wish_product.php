...
<head>
    ...
    <title>Gender wish product</title>
    ...
    <section class="products">
        ...
        <section>
            <div class="product-container">
                ...
                <?php
                $gender = $_GET['gender'];
                $select_products = $conn->prepare("SELECT * FROM `products` WHERE gender LIKE '%{$gender}%'");
                ...
                ?>
                        <div class="each_product_container ">
                            ...
                            <form action="" method="post" class="box">
                                ...
                                <a href="productDetail.php?pid=<?= $fetch_product['id']; ?>&&gender=<?= $gender ?>">
